          ...
          <div class="col-sm-3">
            <section class="panel">
              <div class="panel-body">
                <a href="inbox" class="btn btn-compose">
                  <i class="fa fa-pencil"></i>  Compose Mail
                  </a>
                <ul class="nav nav-pills nav-stacked mail-nav">
                  <li class="active"><a href="inbox"> <i class="fa fa-inbox"></i> Inbox  <span class="label label-theme pull-right inbox-notification">3</span></a></li>
            ...
            <section class="panel">
              <div class="panel-body">
                <ul class="nav nav-pills nav-stacked labels-info ">
                  ...
                  <li>
                    <a href="#">
                        <img src="{{url('system')}}/img/friends/fr-10.jpg" class="img-circle" width="20">Laura
                        <p><span class="label label-success">Available</span></p>
                      </a>
                  </li>
                  <li>
                    <a href="#">
                        <img src="{{url('system')}}/img/friends/fr-05.jpg" class="img-circle" width="20">David
                        <p><span class="label label-danger"> Busy</span></p>
                      </a>
                  </li>
                  <li>
                    <a href="#">
                        <img src="{{url('system')}}/img/friends/fr-01.jpg" class="img-circle" width="20">Mark
                        <p>Offline</p>
                      </a>
                  </li>
                  <li>
                    <a href="#">
                        <img src="{{url('system')}}/img/friends/fr-03.jpg" class="img-circle" width="20">Phillip
                        <p>Offline</p>
                      </a>
                  </li>
                  <li>
                    <a href="#">
                        <img src="{{url('system')}}/img/friends/fr-02.jpg" class="img-circle" width="20">Joshua
                        <p>Offline</p>
                      </a>
                  </li>
                </ul>
                  ...
                  <table class="table table-inbox table-hover">
                    <tbody>
                      <tr class="unread">
                        ...
                        <td class="view-message  dont-show"><a href="inbox">Google Inc.</a></td>
                        <td class="view-message "><a href="inbox">Your new account is ready.</a></td>
                      ...
                      <tr class="unread">
                        ...
                        <td class="inbox-small-cells"><i class="fa fa-star"></i></td>
                        <td class="view-message dont-show"><a href="inbox">Mark Thompson</a></td>
                        <td class="view-message"><a href="inbox">Last project updates</a></td>
                      ...
                      <tr class="unread">
                        ...
                        <td class="inbox-small-cells"><i class="fa fa-star"></i></td>
                        <td class="view-message dont-show"><a href="inbox">Wonder Corp.</a></td>
                        <td class="view-message"><a href="inbox">Thanks for your registration</a></td>
                        <td class="view-message inbox-small-cells"></td>
                        <td class="view-message text-right">March 15</td>
                      </tr>
                      <tr class="">
                        ...
                        <td class="inbox-small-cells"><i class="fa fa-star"></i></td>
                        <td class="view-message dont-show"><a href="inbox">Facebook</a></td>
                        <td class="view-message"><a href="inbox">New Friendship Request</a></td>
                        <td class="view-message inbox-small-cells"></td>
                      ...
                      <tr class="">
                        ...
                        <td class="view-message dont-show"><a href="inbox">Mark Webber <span class="label label-danger pull-right">urgent</span></a></td>
                        <td class="view-message"><a href="inbox">The server is down</a></td>
                        <td class="view-message inbox-small-cells"></td>
                      ...
                      <tr class="">
                        ...
                        <td class="inbox-small-cells"><i class="fa fa-star inbox-started"></i></td>
                        <td class="view-message dont-show"><a href="inbox">Facebook</a></td>
                        <td class="view-message"><a href="inbox">New message from Patrick S.</a></td>
                        <td class="view-message inbox-small-cells"><i class="fa fa-paperclip"></i></td>
