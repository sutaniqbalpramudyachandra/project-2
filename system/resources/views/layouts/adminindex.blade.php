...
<body>
  <section id="container">
    ...
    <header class="header black-bg">
      ...
      <!--logo start-->
      <a href="admin" class="logo"><b>S.I.P.C<span>SECURE</span></b></a>
      <!--logo end-->
        ...
        <ul class="nav top-menu">
          ...
          <li class="dropdown">
            ...
            <ul class="dropdown-menu extended tasks-bar">
              ...
              <li class="external">
                <a href="{{url('system')}}/#">See All Tasks</a>
              </li>
            </ul>
          </li>
          <!-- settings end -->
          ...
          <li id="header_inbox_bar" class="dropdown">
            ...
            <ul class="dropdown-menu extended inbox">
              ...
              <li>
                <a href="admin#">
                  <span class="photo"><img alt="avatar" src="{{url('system')}}/img/ui-zac.jpg"></span>
                  <span class="subject">
              ...
              <li>
                <a href="admin#">
                  <span class="photo"><img alt="avatar" src="{{url('system')}}/img/ui-divya.jpg"></span>
                  <span class="subject">
              ...
              <li>
                <a href="admin#">
                  <span class="photo"><img alt="avatar" src="{{url('system')}}/img/ui-danro.jpg"></span>
                  <span class="subject">
              ...
              <li>
                <a href="admin#">
                  <span class="photo"><img alt="avatar" src="{{url('system')}}/img/ui-sherman.jpg"></span>
                  <span class="subject">
  ...
  <script src="{{url('system')}}/lib/bootstrap/js/bootstrap.min.js"></script>
  <script class="include" type="text/javascript" src="{{url('system')}}/lib/jquery.dcjqaccordion.2.7.js"></script>
  <script src="{{url('system')}}/lib/jquery.scrollTo.min.js"></script>
  <script src="{{url('system')}}/lib/jquery.nicescroll.js" type="text/javascript"></script>
  <script src="{{url('system')}}/lib/jquery.sparkline.js"></script>
  <!--common script for all pages-->
  <script src="{{url('system')}}/lib/common-scripts.js"></script>
  <script type="text/javascript" src="{{url('system')}}/lib/gritter/js/jquery.gritter.js"></script>
  <script type="text/javascript" src="{{url('system')}}/lib/gritter-conf.js"></script>
  <!--script for this page-->
  <script src="{{url('system')}}/lib/sparkline-chart.js"></script>
  <script src="{{url('system')}}/lib/zabuto_calendar.js"></script>
  <script type="text/javascript">
    $(document).ready(function() {
      var unique_id = $.gritter.add({
        // (string | mandatory) the heading of the notification
        title: 'Hallo Pak Razy :)',
        // (string | mandatory) the text inside the notification
        text: 'NIM saya : 3042019010',
        // (string | optional) the image to display on the left
        image: '{{url('system')}}/img/kibul123.jpg',
